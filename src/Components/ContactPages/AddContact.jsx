...
response =  this.props.handleAddContact({
   ...
   if (response.status =="success"){
    ...
    render(){
        console.log("isUpdating:", this.props.isUpdating); // تحقق من قيمة isUpdating
        console.log("selectedContact:", this.props.selectedContact); // تحقق من قيمة selectedContact
    return(
        <div className="border col-12 text-white p-2">
           ...
           <div className="col012 text-center text-danger">
         ...
         <div className="col012 text-center text-success">
          {this.state.successMessage}
          </div>
            )}

<div className={`col-12 p-1 ${this.props.isUpdating ? 
  "col-md-4 offset-md-2" : "col-md-6 offset-md-3"}`}>
...
<div className="col-12 col-md-4 p-1">
    {this.props.isUpdating && (
        <button className="btn btn-secondary form-control btn-sm" onClick={this.handleCancle}>
            Cancel
        </button>
    )}
</div>
